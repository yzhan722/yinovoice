...
/** 管理员-聊天历史（独立于 user/chat-history，后续对接管理端接口） */
...
const getColumns = (): PrimaryTableCol[] => [
  { title: t('pages.aiVoice.userCenter.chatHistory.sessionId'), colKey: 'sessionId', width: 200 },
  { title: t('pages.aiVoice.userCenter.chatHistory.startTime'), colKey: 'startTime', width: 180 },
  { title: t('pages.aiVoice.userCenter.chatHistory.endTime'), colKey: 'endTime', width: 180 },
  { title: t('pages.aiVoice.userCenter.chatHistory.messages'), colKey: 'messageCount', width: 120 },
  { title: t('pages.aiVoice.userCenter.chatHistory.duration'), colKey: 'duration', width: 120 },
  { title: 'Operation', colKey: 'op', width: 150, fixed: 'right' },
];
...
.chat-history {
  ...
  .messages-container {
    ...
    .message-item {
      ...
      .message-time { font-size: 12px; color: var(--td-text-color-placeholder); }
    }
  }
}
</style>
