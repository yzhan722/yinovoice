...
class RuntimeVoiceProfile:
    ...
    def from_mapping(cls, value: object) -> RuntimeVoiceProfile:
        ...
        return cls(
            ...
            tts_voice=_tts_voice_or_default(data["tts_voice"]),
        )
...
class RuntimeCustomerService:
    ...
    def from_mapping(cls, value: object) -> RuntimeCustomerService:
        ...
        return cls(
            ...
            platform_prompt=_str(data["platform_prompt"], "platform prompt"),
...
def _tts_voice_or_default(value: object) -> str:
    """Accept supported Realtime voices; fall back instead of killing the call."""

    result = _str(value, "tts voice")
    if result in _TTS_VOICES:
        return result
    return "longanqian"
